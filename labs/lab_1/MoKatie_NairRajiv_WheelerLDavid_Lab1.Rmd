...
For the Logistic regression binomial model with Temperature and Pressure included, we see that a unit increase in temperature changes the odds of failure by 1.1 times
...
1/exp(summary(model_a.1)$coefficients)
```
For the Logistic regression binary model with Temperature and Pressure included, we see that a unit increase in temperature changes the odds of failure by 1.25 times.
