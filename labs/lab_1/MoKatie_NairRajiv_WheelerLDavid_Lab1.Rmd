...
* enerate array(23) of binomials 0-6 using the built in rbinom function
* replace o.ring2 with above generated binom values, updating only the rows corresponding to sample
