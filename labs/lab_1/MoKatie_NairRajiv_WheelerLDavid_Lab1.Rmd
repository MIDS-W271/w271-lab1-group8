...
Because the O.ring column contains more than 2 outcomes, we also created a new factor variable to binarize the dependent variable. This new column, `O.ringBinary`, has an outcome of 1 if the number of primary O-ring failures in a launch was 1 or greater, otherwise, `O.ringBinary` is equal to 0.
