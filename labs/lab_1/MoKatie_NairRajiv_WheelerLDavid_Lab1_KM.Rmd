...
```{r}
#If we don't use a binary model, then we should just delete this
...
#not sure we need this as it takes up half a page? this code block is hidden
```
...
```{r, fig.width=5, fig.height=3.5}
# diagnotics
plot(model_4, which=1, pch=20, cex=2)
# Figure legend
text(x=0.18, y=0.3,labels = "Figure 7", cex=0.9)
# diagnotics
plot(model_4, which=2, pch=20, cex=2)
# Figure legend
